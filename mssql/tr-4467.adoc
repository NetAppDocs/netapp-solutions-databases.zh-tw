...
link:https://www.netapp.com/pdf.html?item=/media/16865-tr-4467.pdf["TR-4467：Windows 上搭載 Microsoft SQL Server 的 SAP - 使用NetApp Clustered Data ONTAP和SnapCenter 的最佳實踐"^]
